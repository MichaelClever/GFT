...
import { GamesGodsGradesBookInner } from './GamesGodsGradesBookInner';
import Link from 'next/link';
import { ArrowLeft } from 'lucide-react';

export function GamesGodsGradesBookWrapper() {
    ...
    return (
        <div className="relative w-full min-h-[650px] flex flex-col items-center">
            ...
            <div className="relative w-full max-w-[1000px] flex justify-center items-center py-10 px-4">
                {isClient ? (
                    <GamesGodsGradesBookInner />
                ) : (
                    <div className="w-[480px] h-[650px] bg-[#381116] rounded-r-xl border-[5px] border-[#e0a2a5] shadow-[20px_20px_40px_rgba(0,0,0,0.8)] flex items-center justify-center animate-pulse">
                        <div className="text-[#e0a2a5] font-cinzel text-xl">Opening Volume...</div>
                    </div>
                )}
