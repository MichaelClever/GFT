...
const Page = forwardRef<HTMLDivElement, PageProps>((props, ref) => {
  return (
    <div className={`page bg-[#fdf5d3] text-[#3a1d10] shadow-[inset_0_0_20px_rgba(0,0,0,0.1),inset_0_0_2px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center p-8 relative overflow-hidden ${props.className || ''}`} ref={ref}>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Page className="bg-[#1f110a] bg-[url('/GFT/leather.jpg')] bg-repeat border-[5px] border-[#8c6a1d] shadow-[inset_0_0_60px_rgba(0,0,0,1)] rounded-l-md">
                ...
                <Page number="2">
                    <div className="h-full flex flex-col font-lora">
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug">Research on the WFF ‘N PROOF<br/>Instructional Gaming Program</h2>
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify indent-6">
                        ...
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify text-[#5c3a21]">
                        ...
                        <p className="text-[0.92rem] leading-relaxed text-justify text-[#5c3a21]">
                ...
                <Page number="3">
                    <div className="h-full flex flex-col font-lora">
                        <p className="mb-8 text-[0.92rem] leading-relaxed text-justify text-[#5c3a21]">
                        ...
                        <div className="w-12 h-1 bg-[#8c6a1d] mb-6 mx-auto opacity-50"></div>
                        <h2 className="font-cinzel-decorative text-2xl font-bold mb-4 text-[#5c3a21] text-center">Higher IQ Scores</h2>
                        <p className="text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                <Page number="4">
                    <div className="h-full flex flex-col font-lora">
                        <p className="mb-10 text-[0.92rem] leading-relaxed text-justify">
                            ...problem-solving skills utilized in such exercises.
                        </p>
                        <div className="w-12 h-1 bg-[#8c6a1d] mb-6 mx-auto opacity-50"></div>
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug text-center">Increased Math Achievement</h2>
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                {/* 6. Page 5 */}
                <Page number="5">
                    <div className="h-full flex flex-col font-lora flex-1 pt-6">
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug">Low Ability Students<br/>Improve the Most!</h2>
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                <Page number="6">
                    <div className="h-full flex flex-col font-lora flex-1 pt-6">
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug">Dramatically Improved<br/>Attendance</h2>
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                {/* 8. Page 7 */}
                <Page number="7">
                    <div className="h-full flex flex-col font-lora flex-1">
                        <p className="mb-10 text-[0.92rem] leading-relaxed text-justify indent-6">
                        ...
                        <div className="w-12 h-1 bg-[#8c6a1d] mb-6 mx-auto opacity-50"></div>
                        <h2 className="font-cinzel-decorative text-2xl font-bold mb-6 text-[#5c3a21] leading-snug text-center">Increased Skill in<br/>Applying Math Ideas</h2>
                        <p className="text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                <Page number="8">
                    <div className="h-full flex flex-col font-lora flex-1 pt-6">
                        <p className="mb-6 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                {/* 10. Page 9 */}
                <Page number="9">
                    <div className="h-full flex flex-col font-lora justify-center">
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug text-center">Dramatic Success in Reinforcing Concepts through Simple Scoring</h2>
                        <p className="mb-6 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                <Page number="10">
                    <div className="h-full flex flex-col font-lora flex-1">
                        ...
                        <div className="w-12 h-1 bg-[#8c6a1d] mb-6 mx-auto opacity-50"></div>
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug text-center">Future Directions for Research – the<br/>“Basic Skills” Conundrum</h2>
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                <Page number="11">
                    <div className="h-full flex flex-col font-lora flex-1 pt-6">
                        <h2 className="font-cinzel-decorative text-[1.4rem] font-bold mb-6 text-[#5c3a21] leading-snug">Study and Beta Test<br/>Schools Welcome</h2>
                        <p className="mb-4 text-[0.92rem] leading-relaxed text-justify indent-6">
                ...
                {/* 13. Page 12 */}
                <Page number="12">
                    <div className="h-full flex flex-col font-lora justify-center items-center px-2">
                        <p className="mb-8 text-[0.95rem] leading-relaxed text-justify indent-6 font-bold text-[#5c3a21]">
                        ...
                        <p className="mb-12 text-[0.95rem] leading-relaxed text-justify indent-6 font-bold text-[#5c3a21]">
                        ...
                        <div className="w-16 h-1 bg-[#8c6a1d] mb-6 mx-auto opacity-50"></div>
                        <p className="text-[1rem] leading-relaxed italic font-bold text-[#3a1d10] text-center">
                ...
                {/* 14. Back Cover */}
                <Page className="bg-[#1f110a] bg-[url('/GFT/leather.jpg')] bg-repeat border-[5px] border-[#8c6a1d] shadow-[inset_0_0_60px_rgba(0,0,0,1)] rounded-r-md">
                    {/* Dark Leather Texture Overlay */}
                    <div className="absolute inset-0 bg-[#3a1d10]/40 mix-blend-multiply pointer-events-none"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-[#110500]/70 to-transparent pointer-events-none"></div>
                    ...
                    <div className="h-full w-full flex flex-col items-center justify-center text-[#fdf5d3] text-center relative z-10">
                        ...
                        <div className="w-20 h-20 rounded-full border border-[#d4af37] flex items-center justify-center mt-16 opacity-30">
                            <span className="font-cinzel text-xs tracking-widest text-[#d4af37]">Fin.</span>
                        </div>
                    </div>
                </Page>
