...
export function ChatInput() {
    return (
        <section className="w-full max-w-[900px] mx-auto px-4 z-10 relative mb-16 pt-8 flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            {/* Chat Box */}
            <div className="flex-1 w-full max-w-[600px] min-w-[300px]">
