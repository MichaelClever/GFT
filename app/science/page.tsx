...
export const metadata: Metadata = {
    alternates: {
        canonical: "https://gamesforthinkers.org/science",
    },
};


export default function SciencePage() {
    const qntProduct = getProductByHandle("queries-n-theories-the-game-of-science-and-language");
    return (
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-12">
                    <div className="animate-in fade-in zoom-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                        <ProductCard 
                            ...
                            detailsVideoUrl="https://player.vimeo.com/video/1193810331?share=copy&fl=sv&fe=ci&autoplay=1&muted=0"
                            ...
                            shopifyMerchandiseId={qntProduct?.id}
                            price={qntProduct?.price}
                        />
                    </div>
                </div>
            </div>
