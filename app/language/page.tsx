...
export const metadata: Metadata = {
    alternates: {
        canonical: "https://gamesforthinkers.org/language",
    },
};


export default function LanguagePage() {
    const lingProduct = getProductByHandle("linguishtik-a-creative-language-game");
    const onWordsProduct = getProductByHandle("on-words-the-game-of-word-structures");
    return (
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-12">
                    <div className="animate-in fade-in zoom-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                        <ProductCard 
                            ...
                            shopifyMerchandiseId={lingProduct?.id}
                            price={lingProduct?.price}
                        />
                    </div>
                    <div className="animate-in fade-in zoom-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                        <ProductCard 
                            ...
                            shopifyMerchandiseId={onWordsProduct?.id}
                            price={onWordsProduct?.price}
                        />
                    </div>
                </div>
            </div>
